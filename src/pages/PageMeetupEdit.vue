            ...
            <aside class="is-medium menu">
              <div class="meetup-side-box">
                ...
                <div class="meetup-side-box-place m-b-sm">
                  <p>
                    <b :style="{'color': '#212121', 'font-weight': 'bold'}">Choose Category</b>
                  </p>
                  <div class="field">
                    <div class="select">
  ...
  methods: {
    ...
    fetchMeetupHandler() {
      this.fetchMeetup(this.meetupId)
        .then(meetup => {
          if (meetup.meetupCreator._id !== this.currentUser._id) {
    ...
    updateMeetupHandler() {
      this.updateMeetup(this.meetup)
        .then(() => {
          this.$toasted.success("Meetup has been succesfully updated!", {
            duration: 3000
          });
        })
        .catch(error => console.log(error));
